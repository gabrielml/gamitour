...
<tr>
<th>ID prueba deportiva <i class="fas fa-sort"></th>
...
<c:forEach items="${listado}" var="unaPDeportiva">	
	<tr>
		...
		<td><a id="icono" href="BorrarPDeportiva.do?nombrePDeportivaBorrar=${unaPDeportiva[1]}"><i class="fas fa-trash-alt"></i></a></td>
		<td><a id="icono" href="contenido/pDeportivas/ModificarPDeportiva.jsp?idpruebadeportiva=${unaPDeportiva[0]}&nombre=${unaPDeportiva[1]}&fechainicio=${unaPDeportiva[2]}&fechafin=${unaPDeportiva[3]}&explicacion=${unaPDeportiva[4]}&puntos=${unaPDeportiva[5]}&parada=${unaPDeportiva[6]}&pdf=${unaPDeportiva[7]}&video=${unaPDeportiva[8]}"><i class="far fa-edit"></i></a></td>
	</tr>
</c:forEach>
</tbody>
</table>
