            ...
            <form action="../../ModificarPDeportiva.do">
                <table>
                    ...
                    <tr>
                        ...
                        <td><textarea rows="6" cols="40" name="explicacionNueva" maxlength="200"><%=request.getParameter("explicacion")%></textarea>
                            <!-- <input type="text" name="explicacionNueva" value="<%=request.getParameter("explicacion")%>"/> --></td>
                    </tr>
                    <tr>
                        <td>Puntos: </td>
                    ...
                    <tr>
                        <td>Pdf: </td>
                        <td><input type="text" name="pdfNuevo" value="<%=request.getParameter(" pdf ")%>"/></td>
                    </tr>
                    <tr>
                        <td>Video: </td>
                        <td><input type="text" name="videoNuevo" value="<%=request.getParameter(" video ")%>"/></td>
                    </tr>
                ...
                <div class="botones">
                    ...
                    <div class="boton">
                        ...
                        <a href="../../MostrarPDeportivas.do" id="pruebasd2"><input class="button" type="button" value="Volver"></a>
