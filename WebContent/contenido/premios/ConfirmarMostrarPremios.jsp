...
<th>DESCRIPCI&Oacute;N <i class="fas fa-sort"></th>
<th>IMAGEN <i class="fas fa-sort"></th>
<th>FECHA ACTIVACI&Oacute;N <i class="fas fa-sort"></th>
...
<c:forEach items="${listado}" var="unPremio">	
	<tr>
		...
		<td><a id="icono" href="BorrarPremio.do?idBorrar=${unPremio.nombre}"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                    <td>
                                        <a id="icono" href="��������.do?idpremio=${unPremio.idpremio}&nombre=${unPremio.nombre}&descripcion=${unPremio.descripcion}&imagen=${unPremio.imagen}&fechaactivacion=${unPremio.fechaactivacion}&fechaconsumo=${unPremio.fechaconsumo}&puntos=${unPremio.puntos}&puntos=${unPremio.cliente.nick}"><i class="far fa-edit"></i></a>
                                    </td>
                            </tr>
                            </c:forEach>
                            </tbody>
