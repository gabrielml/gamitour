    ...
    <body>
        ...
        <table>
            ...
            <table>
                ...
                <tr>
                    <td>Fecha nacimiento :
                        <%= request.getAttribute("fechaNaci") %>
                    </td>
                </tr>
                <tr>
                    <td>Email :
                ...
                <tr>
                    <td>C&oacute;digo postal :
                        <%= request.getAttribute("cp") %>
                    </td>
                </tr>
                <tr>
                    <td>Avatar :
                        <%= request.getAttribute("avatar") %>
                    </td>
                </tr>
                <tr>
                    <td>Puntos :
                        <%= request.getAttribute("puntos") %>
                    </td>
                </tr>
                <tr>
                    <td>Fecha registro :
                        <%= request.getAttribute("fecharegi") %>
                    </td>
                </tr>
                <tr>
                    <td>Rol :
                ...
                <tr>
                    <td>Premios :
                        <%= request.getAttribute("premios")%>
                    </td>
                </tr>
                <tr>
                    <td>Votos :
                        <%= request.getAttribute("votos")%>
                    </td>
                </tr>
                <tr>
                    <td>Actividades :
                ...
                <tr>
                    <td>Multimedia :
                        <%= request.getAttribute("multimedias")%>
                    </td>
                </tr>
